  ...
  return (
    <section className="p-6 space-y-2">
      ...
      <p>
        ...
        you and Fragments of Eternity.
      </p>
      <p>
        Under no circumstances shall Fragments of Eternity team be liable for
        ...
        Fragments of Eternity team or an authorized representative has been
      ...
      <p>
        Fragments of Eternity will not be responsible for any outcome that may
        occur during the course of usage of our resources. We reserve the rights
      ...
      <p>
        These Terms & Conditions are a contract between you and Fragments of
        Eternity (referred to in these Terms & Conditions as &quot;Fragments of
        Eternity&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the
        provider of the Fragments of Eternity website and the services
        accessible from the Fragments of Eternity website (which are
        collectively referred to in these Terms & Conditions as the
        &quot;Fragments of Eternity Service&quot;).
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the Fragments of
        Eternity Service. In these Terms & Conditions, &quot;you&quot; refers
      ...
      <ul>
        ...
        <li>
          ...
          refers to Fragments of Eternity, that is responsible for your
          information under this Terms & Conditions.
        </li>
        <li>
          Country: where Fragments of Eternity or the owners/founders of
          Fragments of Eternity are based, in this case is{" "}
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Fragments of
          Eternity and use the services.
        </li>
        <li>
          Service: refers to the service provided by Fragments of Eternity as
        ...
        <li>
          Website: Fragments of Eternity&apos;s site, which can be accessed via
          this URL: foe.ioannis-tsirovasilis.com
        </li>
        <li>
          You: a person or entity that is registered with Fragments of Eternity
          to use the Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Fragments of Eternity or its affiliates,
      ...
      <p>
        ...
        apply to transactions at Fragments of Eternity. We&apos;ll be as brief
        as our attorneys will allow. The main thing to remember is that by
        placing an order or making a purchase at Fragments of Eternity, you
        agree to the terms along with Fragments of Eternity&apos;s Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        ...
        Eternity with respect to the website shall remain the sole and exclusive
        property of Fragments of Eternity.
      </p>
      <p>
        Fragments of Eternity shall be free to use, copy, modify, publish, or
      ...
      <p>
        ...
        of Eternity. We are not responsible for the content, accuracy or
      ...
      <p>
        ...
        You do not need to specifically inform Fragments of Eternity when you
        stop using the Service. You acknowledge and agree that if Fragments of
        Eternity disables access to your account, you may be prevented from
      ...
      <p>
        ...
        the website. You agree that Fragments of Eternity has no obligation to
      ...
      <p>
        You acknowledge and agree that Fragments of Eternity shall not be
        ...
        decency, quality or any other aspect thereof. Fragments of Eternity does
      ...
      <p>
        Fragments of Eternity may, in its sole discretion, at any time and for
      ...
      <p>
        ...
        Fragments of Eternity, in the event that you fail to comply with any
      ...
      <p>
        Termination of this Agreement will not limit any of Fragments of
        Eternity&apos;s rights or remedies at law or in equity in case of breach
      ...
      <p>
        ...
        kind. To the maximum extent permitted under applicable law, Fragments of
        Eternity, on its own behalf and on behalf of its affiliates and its and
        ...
        limitation to the foregoing, Fragments of Eternity provides no warranty
      ...
      <p>
        Without limiting the foregoing, neither Fragments of Eternity nor any
        Fragments of Eternity&apos;s provider makes any representation or
        warranty of any kind, express or implied: (i) as to the operation or
        availability of the website, or the information, content, and materials
        or products included thereon; (ii) that the website will be
        uninterrupted or error-free; (iii) as to the accuracy, reliability, or
        currency of any information or content provided through the website; or
        (iv) that the website, its servers, the content, or e-mails sent from or
        on behalf of Fragments of Eternity are free of viruses, scripts, trojan
      ...
      <p>
        ...
        this Agreement and your exclusive remedy for all of the foregoing shall
        be limited to the amount actually paid by you for the website.
      </p>
      <p>
        To the maximum extent permitted by applicable law, in no event shall
        Fragments of Eternity or its suppliers be liable for any special,
        ...
        provision of this Agreement), even if Fragments of Eternity or any
      ...
      <p>
        ...
        notices published by Fragments of Eternity on the Services, shall
        constitute the entire agreement between you and Fragments of Eternity
        concerning the Services. If any provision of this Agreement is deemed
        ...
        waiver of such term or any other term, and Fragments of Eternity&apos;s
        failure to assert any right or provision under this Agreement shall not
        constitute a waiver of such right or provision. YOU AND Fragments of
        Eternity AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
      ...
      <p>
        ...
        agree to the new terms, you are no longer authorized to use Fragments of
        Eternity.
      </p>
      ...
      <p>
        ...
        and contemporaneous written or oral agreements between you and Fragments
        of Eternity.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Fragments of Eternity&apos;s services, which
        Fragments of Eternity will provide to you at the time of such use or
        purchase.
      </p>
      ...
      <p>
        ...
        thereof), are owned by Fragments of Eternity, its licensors or other
        ...
        in part, without the express prior written permission of Fragments of
        Eternity, unless and except as is expressly provided in these Terms &
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Fragments of Eternity&apos;s
        INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
        action, or other controversy between you and Fragments of Eternity
      ...
      <p>
        ...
        the name, address, and contact information of the party giving it, the
        facts giving rise to the dispute, and the relief requested. You must
        send any Notice of Dispute via email to:{" "}
        <a href="mailto:ioannistsirovasilis@gmail.com">
          ioannistsirovasilis@gmail.com
        </a>
        . Fragments of Eternity will send any Notice of Dispute to you by mail
        to your address if we have it, or otherwise to your email address. You
        and Fragments of Eternity will attempt to resolve any dispute through
        informal negotiation within sixty (60) days from the date the Notice of
        Dispute is sent. After sixty (60) days, you or Fragments of Eternity may
      ...
      <p>
        ...
        or property pending the completion of arbitration. Any and all legal,
      ...
      <p>
        ...
        and will become the sole property of Fragments of Eternity without any
        compensation or credit to you whatsoever. Fragments of Eternity and its
      ...
      <p>
        ...
        that all Promotions may be governed by separate rules that may contain
        ...
        determine whether or not you are eligible to participate. If you enter
        any Promotion, you agree to abide by and to comply with all Promotions
        Rules.
      </p>
      <p>
      ...
      <p>
        ...
        of Fragments of Eternity. Fragments of Eternity will be entitled to
        ...
        you. Fragments of Eternity operates and controls the Fragments of
        Eternity Service from its offices in . The Service is not intended for
        distribution to or use by any person or entity in any jurisdiction or
        country where such distribution or use would be contrary to law or
        regulation. Accordingly, those persons who choose to access the
        Fragments of Eternity Service from other locations do so on their own
        ...
        (which include and incorporate the Fragments of Eternity Privacy Policy)
        contains the entire understanding, and supersedes all prior
        understandings, between you and Fragments of Eternity concerning its
      ...
      <p>Fragments of Eternity does not provide warranties or guarantees.</p>
      <p>
        In no event shall Fragments of Eternity be liable for any special,
      ...
      <p>
        The Fragments of Eternity Service and its contents are provided
        &quote;as is&quote; and &quote;as available&quote; without any warranty
        or representations of any kind, whether express or implied. Fragments of
        Eternity is a distributor and not a publisher of the content supplied by
        third parties; as such, Fragments of Eternity exercises no editorial
        ...
        service or merchandise provided through or accessible via the Fragments
        of Eternity Service. Without limiting the foregoing, Fragments of
        Eternity specifically disclaims all warranties and representations in
        any content transmitted on or in connection with the Fragments of
        Eternity Service or on sites that may appear as links on the Fragments
        of Eternity Service, or in the products provided as a part of, or
        otherwise in connection with, the Fragments of Eternity Service,
        including without limitation any warranties of merchantability, fitness
        for a particular purpose or non-infringement of third party rights. No
        oral advice or written information given by Fragments of Eternity or any
        ...
        change without notice. Without limiting the foregoing, Fragments of
        Eternity does not warrant that the Fragments of Eternity Service will be
